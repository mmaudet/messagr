...
export const es: Readonly<Record<CopyKey, string>> = {
  ...
  settings_row_lang_hint:
    'Español · siete idiomas, elegidos al primer arranque',
  ...
  list_reinstalled_stranded:
    'Este dispositivo ha perdido sus claves de cifrado, probablemente en una reinstalación. Los mensajes recibidos antes son ilegibles y no pueden recuperarse. Para volver a escribir aquí hace falta una nueva invitación.',
  list_empty:
  ...
  call_start: 'Llamar',
  call_start_video: 'Videollamada',
  call_ringing: 'Llamando…',
  call_incoming: 'Llamada entrante',
  call_incoming_video: 'Videollamada entrante',
  call_answer_video: 'Responder con vídeo',
  call_answer_audio: 'Responder sin vídeo',
  ...
  call_camera_refused:
    'No se ha podido abrir su cámara. La llamada continúa sin su imagen.',
  ...
  composer_document: 'Añadir un documento',
  composer_attach: 'Adjuntar',
  share_not_yet: 'Este archivo no se ha enviado, y Messagr no lo ha guardado.',
  share_too_large: 'Este archivo es demasiado grande para enviarlo.',
  share_unreadable: 'Este archivo no se ha podido leer.',
  ...
  settings_keep_every: 'Guardar las fotos recibidas',
  settings_keep_every_hint:
    'Cada foto recibida va a su galería antes de que usted la haya visto, incluidas las de personas que aún no conoce. Allí puede leerla cualquier aplicación a la que dé acceso a sus fotos, y quien la envió ya no puede retirarla.',
  settings_keep_every_future:
    'Apagarlo no recupera nada: lo que se guardó sigue guardado.',
  ...
  notify_ringing_video_body: 'Videollamada entrante',
  ...
  file_kept: 'Documento guardado donde lo ha elegido.',
  file_keep_failed: 'El documento no se ha podido guardar.',
  'file_size_kb %@': '%@ KB',
  'file_size_mb %@': '%@ MB',
